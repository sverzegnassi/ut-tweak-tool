...
Style.PageHeadStyle {
    ...
    property color panelBackgroundColor: UbuntuColors.orange
    property color panelHighlightColor: Theme.palette.selected.background
    property color panelForegroundColor: "white"
    ...
    Item {
        ...
        height: sectionsRow.visible ? units.gu(3) : 0
